# DNS-Ping Monitoring with real data from Hetzner Helsinki in Finnland
...
In contrast to [https://github.com/thomasmerz/dnspingtest_rrd](https://github.com/thomasmerz/dnspingtest_rrd) this repo contains "real data" from my Linux server at **Hetzner Helsinki in Finnland** (pushed nightly or on request).  
